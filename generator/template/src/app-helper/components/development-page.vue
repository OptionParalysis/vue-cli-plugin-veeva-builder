  ...
  <section id="development-page" :class="{tablet: !isFullFunctional}">
    ...
    <footer>
      <ul class="additional-info">
        ...
        <li><a href="https://github.com/serhiichuk/vue-cli-plugin-veeva-builder" target="_blank">CLI Plugin Clm Helper</a>
        </li>
        ,
...
<script>
  ...
  import IgnoredSlides from 'vue-cli-plugin-veeva-builder/lib/sharedUtils/IgnoredSlides'
